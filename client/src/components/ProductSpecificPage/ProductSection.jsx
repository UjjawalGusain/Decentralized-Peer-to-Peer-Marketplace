  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mt-4 bg-white p-3 rounded-xl shadow-sm border border-gray-100 w-fit">
          ...
          <div>
            <span className="text-sm text-gray-500 font-medium block">Seller</span>
            <span className="text-lg font-semibold text-slate-900">
              {product.sellerId?.profile?.name || "Unknown Seller"}
            </span>
          </div>
        </div>
      </div>
      ...
      {product.videoLink && (
        <div className="mb-8">
          <video controls src={product.videoLink} className="w-full max-h-96 rounded-md shadow" />
        </div>
      )}
      ...
      {product.location?.address && (
        <section className="bg-white p-6 rounded-md shadow-sm">
          ...
          <p>
            {product.location.address}, {product.location.city}, {product.location.country}
          </p>
        </section>
      )}
