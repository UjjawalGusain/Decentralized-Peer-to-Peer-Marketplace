        ...
        <div className="flex justify-between items-center py-1">
          ...
          <div className="flex items-center space-x-4 w-full md:w-auto">
            <div className="text-2xl font-bold text-blue-600 w-fit h-fit">
              <img src="/logo_text.png" alt="Logo" width="80" height="80" />
            </div>
          ...
          <nav className="hidden lg:flex gap-6 text-sm text-gray-600 items-center">
            {["/", "/browse", "/sell", "/aboutus", "/chat"].map((path, idx) => {
              const label = ["Home", "Browse", "Sell", "About Us", "Messages"][idx];
              return (
                <NavLink
                  key={path}
                  to={path}
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ...
                    (isActive ? " font-semibold underline text-gray-900" : "")
                  }
                >
                  {label}
                </NavLink>
